...
- [application-currencies](/var/www/loom-craft/.ai/tasks/completed/commerce/application-currencies.md)
- [cart-and-checkout-ux-refinements](/var/www/loom-craft/.ai/tasks/completed/commerce/cart-and-checkout-ux-refinements.md)
- [checkout-offline-payment-operations](/var/www/loom-craft/.ai/tasks/completed/commerce/checkout-offline-payment-operations.md)
- [stripe-checkout](/var/www/loom-craft/.ai/tasks/completed/commerce/stripe-checkout.md)
- [ui-defaults-and-checkout-selection](/var/www/loom-craft/.ai/tasks/completed/commerce/ui-defaults-and-checkout-selection.md)
...
- [mobile-device-session-management-dashboard](/var/www/loom-craft/.ai/tasks/completed/mobile/mobile-device-session-management-dashboard.md)
- [mobile-public-api-v1](/var/www/loom-craft/.ai/tasks/completed/mobile/mobile-public-api-v1.md)

### Product

- [product-catalog-json-generation](/var/www/loom-craft/.ai/tasks/completed/product/product-catalog-json-generation.md)
- [product-categories](/var/www/loom-craft/.ai/tasks/completed/product/product-categories.md)
- [product-colors](/var/www/loom-craft/.ai/tasks/completed/product/product-colors.md)
- [product-detail-image-slider](/var/www/loom-craft/.ai/tasks/completed/product/product-detail-image-slider.md)
- [products-discounts](/var/www/loom-craft/.ai/tasks/completed/product/products-discounts.md)
...
- [seo-and-analytics-sitemap-improvements](/var/www/loom-craft/.ai/tasks/completed/ui/seo-and-analytics-sitemap-improvements.md)

### Vendor

- [vendor-product-pricing-currency-label-lkr](/var/www/loom-craft/.ai/tasks/completed/vendor/vendor-product-pricing-currency-label-lkr.md)
- [vendor-public-page-unified-requirements](/var/www/loom-craft/.ai/tasks/completed/vendor/vendor-public-page-unified-requirements.md)
...
- The old flat tracker was preserved at `.ai/tasks/archive/legacy/todo-list-legacy.md`.
...
- On 2026-05-08 the backlog was reorganized into `planned/fulfillment`, `planned/mobile`, and `in-progress/fulfillment`; completed and merged-outdated tasks were moved accordingly.
