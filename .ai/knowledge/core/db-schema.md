...
- `parcel_item_count` (int unsigned, nullable; admin-editable label override)
- `parcel_styles` (text, nullable; admin-editable label override)
- `parcel_materials` (text, nullable; admin-editable label override)
