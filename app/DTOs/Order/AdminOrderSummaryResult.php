...
class AdminOrderSummaryResult
{
     ...
     * @param  array{id: int, shipment_number: string|null, status: string, tracking_number: string|null, carrier: string|null, service_level: string|null, vendor_preparing_at: string|null, vendor_handed_to_admin_at: string|null, admin_received_at: string|null, quality_checked_at: string|null, packed_at: string|null, shipped_at: string|null, delivered_at: string|null}|null  $shipment
