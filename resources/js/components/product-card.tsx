...
export default function ProductCard({
    ...
    return (
        <article className="group flex h-full flex-col overflow-hidden rounded-[32px] border border-(--welcome-border-soft) bg-(--welcome-surface-3) transition hover:-translate-y-1 hover:border-(--welcome-accent)">
            <Link
            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
                <div className="space-y-2">
                    <p className="text-xs uppercase tracking-[0.3em] text-(--welcome-muted-text)">
                        ...
                        {product.vendor_location ? ` • ${product.vendor_location}` : ''}
                    </p>
                ...
                <div className="mt-auto flex items-end justify-between gap-3 text-sm">
                    <span className="text-(--welcome-body-text)">Selling price</span>
