            ...
            <div className="flex h-full min-w-0 flex-1 flex-col gap-4 overflow-x-hidden rounded-xl p-4">
                <div className="rounded-xl border border-sidebar-border/70 bg-sidebar/30 p-6 dark:border-sidebar-border">
                    <div className="flex flex-col gap-2">
                        <p className="text-xs tracking-[0.3em] text-muted-foreground uppercase">Vendor Orders</p>
                        <h2 className="text-2xl font-semibold text-foreground">Fulfill your LoomCraft orders</h2>
                        <p className="text-sm text-muted-foreground">Review every order that includes work from your studio.</p>
                    </div>
                </div>
                            ...
                            >
                                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                    <div className="min-w-0">
                                        ...
                                        <p className="text-lg font-semibold text-foreground">{formatMoney(order.total, order.currency)}</p>
