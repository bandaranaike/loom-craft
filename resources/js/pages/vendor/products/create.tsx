            ...
            >
                <section className="relative z-10 mx-auto grid w-full max-w-7xl gap-8 px-6 pt-4 pb-16 lg:grid-cols-[0.8fr_1.2fr]">
                    <div className="space-y-5">
                        ...
                        <h1 className="font-['Playfair_Display',serif] text-3xl leading-tight md:text-4xl">Register a new heritage piece for review.</h1>
                        <p className="max-w-lg text-sm text-(--welcome-body-text)">
                            Share the provenance, pricing, and materials for each piece. Approved listings are curated for collectors worldwide.
                        </p>
                    ...
                    <div className="relative">
                        <div className="relative rounded-[36px] border border-(--welcome-border) bg-(--welcome-surface-1) p-6 shadow-[0_30px_80px_-45px_var(--welcome-shadow)] lg:p-8">
                            <div className="space-y-2">
                                ...
                                <h2 className="font-['Playfair_Display',serif] text-2xl">Listing details</h2>
                                <p className="text-sm text-(--welcome-body-text)">Provide full production context and media references.</p>
                            </div>
                            ...
                            <Form {...store.form()} className="mt-6 grid gap-5 lg:grid-cols-2" encType="multipart/form-data">
                                {({ processing, errors }) => (
                                    <>
                                        <div className="grid gap-2 lg:col-span-2">
                                            <div className="grid gap-5 lg:grid-cols-3">
                                                <div className="grid gap-2">
                                                    ...
                                                    <input id="product_code" type="text" name="product_code" placeholder="LC-00001" className={inputClassName} required />
                                                ...
                                                <div className="grid gap-2 lg:col-span-2">
                                                    ...
                                                    <input id="name" type="text" name="name" placeholder="Crimson Dumbara Runner" className={inputClassName} required />
                                        ...
                                        <div className="lg:col-span-2">
                                            <ProductColorSelector colors={colors} errorMessage={errors.color_ids} itemErrorMessage={errors['color_ids.0']} />
                                        </div>
                                        ...
                                        <div className="grid gap-4 sm:grid-cols-2 lg:col-span-2">
                                            <div className="grid gap-2">
                                                ...
                                                <input id="materials" type="text" name="materials" placeholder="Hand-spun cotton, natural dyes" className={inputClassName} />
                                            ...
                                            <div className="grid gap-2">
                                                ...
                                                <input id="pieces_count" type="number" name="pieces_count" min="1" placeholder="4" className={inputClassName} />
                                        ...
                                        <div className="grid gap-3 lg:col-span-2">
                                            ...
                                            <p className="text-xs text-(--welcome-muted-80)">Upload one or more images. JPG, PNG, WEBP, or GIF.</p>
                                        ...
                                        <div className="grid gap-2 lg:col-span-2">
                                            <label htmlFor="video" className="text-xs font-semibold tracking-[0.3em] text-(--welcome-muted-text) uppercase">
                                                Optional video
                                            </label>
                                            <p className="text-xs text-(--welcome-muted-80)">MP4, MOV, WEBM, or MKV. Uploaded to YouTube.</p>
                                            <input
                                                id="video"
                                                type="file"
                                                name="video"
                                            ...
                                            />
                                            <InputError message={errors.video} className="text-xs" />
                                        </div>
                                        ...
                                        <p className="text-center text-xs tracking-[0.25em] text-(--welcome-muted-text) uppercase lg:col-span-2">
